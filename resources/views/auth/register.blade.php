...
<div class="register-box">
    <div class="register-logo">
        <a href="../../index2.html"><b>My</b>insentif</a>
    </div>
    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group mb-3">
                    <input id="jabatan" type="jabatan" class="form-control @error('jabatan') is-invalid @enderror" name="jabatan" value="{{ old('jabatan') }}" required autocomplete="jabatan" placeholder="Jabatan">
